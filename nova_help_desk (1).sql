...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/09/2026 às 20:00
...
--
-- Estrutura para tabela `computadores_excluidos`
--
...
--
-- Estrutura para tabela `dispositivos_hardware_original`
--
...
--
-- Despejando dados para a tabela `dispositivos_hardware_original`
--
...
--
-- Estrutura para tabela `dispositivos_telemetria`
--
...
--
-- Despejando dados para a tabela `dispositivos_telemetria`
--
...
--
-- Estrutura para tabela `interacoes_chamado`
--
...
--
-- Estrutura para tabela `secretarias_setores`
--
...
--
-- Despejando dados para a tabela `secretarias_setores`
--
...
--
-- Índices de tabela `computadores_excluidos`
--
...
--
-- Índices de tabela `dispositivos_hardware_original`
--
...
--
-- Índices de tabela `dispositivos_telemetria`
--
...
--
-- Índices de tabela `interacoes_chamado`
--
...
--
-- Índices de tabela `secretarias_setores`
--
...
--
-- Restrições para tabelas `dispositivos_hardware_original`
--
ALTER TABLE `dispositivos_hardware_original`
